...
func ConvToToDoDTO(dbToDo datatypes.Entry) models.EntryDto {
...
func ConvListToToDoDTO(dbToDoList []datatypes.Entry) []models.EntryDto {
...
func ConvToDatabaseToDo(dtoToDo models.EntryDto) datatypes.Entry {
